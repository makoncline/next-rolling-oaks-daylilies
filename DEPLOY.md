...
During PR testing, GitHub Actions only builds this image and does not push it. Re-enable the commented `push` trigger and GHCR login/push steps when `main` should publish images.
